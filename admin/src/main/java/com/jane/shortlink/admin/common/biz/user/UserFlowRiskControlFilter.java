package com.jane.shortlink.admin.common.biz.user;
...
import com.jane.shortlink.admin.config.UserFlowRiskControlConfiguration;
...
import static com.jane.shortlink.admin.common.convention.errorcode.BaseErrorCode.FLOW_LIMIT_ERROR;

/**
 * _@Description: 用户操作流量风控过滤器
 */
@Slf4j
